            ...
            <div className="grid auto-rows-max grid-flow-rows bg-[url('/images/Futsal_Commercial-1.jpg')] bg-no-repeat bg-cover min-h-195 bg-center py-5">
                <form id="edit" action={formAction}>
                    <div className="content w-7xl bg-white mx-auto text-center h-15 p-5">
                        <label>Date:</label>
                        <input type="date" name="date" id="date" defaultValue={toDataInput(match.date)} placeholder="14/13/2025" className="border-1 bg-gray-100 rounded-lg mx-5" />
                        <label>Start Time:</label>
                        <input type="text" name="startTime" id="startTime" defaultValue={match.startTime} placeholder="15:00" className="border-1 bg-gray-100 rounded-lg mx-5" />
                    ...
                    <div className="w-7xl mx-auto mt-5">
                        <div className="grid grid-cols-1"> {/* change to 3 after */}
                            ...
                            <div className="h-100 bg-white mx-auto p-5">
                                ...
                                <textarea id="details" name="details" defaultValue={match.details} placeholder="Details ..." className="border-1 bg-gray-100 rounded-lg w-75 h-80 mt-3"></textarea>
                            </div>
