    ...
    return (
        <>          
            <div className="grid auto-rows-max grid-flow-rows bg-[url('/images/Futsal_Commercial-1.jpg')] bg-no-repeat bg-cover min-h-195 bg-center py-5">
                <div className="bg-[rgba(255,255,255,0.9)] w-7xl mx-auto rounded-lg h-12 py-3">
                ...
                <div className="content w-7xl bg-[rgba(255,255,255,0.9)] grid grid-cols-7 rounded-lg mx-auto p-2 mt-5">
